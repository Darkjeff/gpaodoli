...
/**
 * \file    test/phpunit/GpaodoliFunctionalTest.php
 * \ingroup gpaodoli
 ...
 *
 * @package Testgpaodoli
 */
class GpaodoliFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 150750; // TODO: autodetect?
	...
	{
		$this->url('/custom/gpaodoli/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gpaodoli/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gpaodoli/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gpaodoli/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gpaodoliwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGpaodoli_GpaodoliTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGpaodoli_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
